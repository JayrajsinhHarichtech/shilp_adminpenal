  ...
  export default function Sidebar({ collapsed, setCollapsed }) {
    ...
    return (
      <aside className={`h-full ${collapsed ? "w-20" : "w-64"} transition-all duration-300 bg-gray-800 text-white flex flex-col`}>
        <div className="p-4">
        <button
        onClick={() => setCollapsed(!collapsed)}
        className={`text-2xl p-2 rounded w-full text-left transition-all duration-200 ml-44${collapsed ? 'ml-44' : ''}`}>,
